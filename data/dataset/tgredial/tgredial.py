...
class TGReDialDataset(BaseDataset):
    ...
    def _load_raw_data(self):
        ...
        with open(os.path.join(self.dpath, 'test_data.json'), 'r', encoding='utf-8') as f:
            ...
            # user_g = "data/dataset/tgredial/pkuseg/group/active5.json"
            # user_g = "data/dataset/tgredial/pkuseg/group/inactive5.json"
            # with open(user_g, 'r', encoding='utf-8') as file:
            #     user_g = json.load(file)
            # data = json.load(f)
            # test_data = []
            # for conv in data:
            #     user_id = int(conv.get("user_id"))
            #     if user_id and user_id in user_g:
    ...
    def _data_preprocess(self, train_data, valid_data, test_data):
        ...
        # for data_point, user_data in zip(processed_train_data, train_data):
        #     data_point['user_id'] = user_data['user_id']
