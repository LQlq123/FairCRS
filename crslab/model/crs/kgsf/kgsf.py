...
class KGSFModel(BaseModel):
    ...
    def pretrain_infomax(self, batch):
        ...
        """
        words, entity_labels, user_id = batch
...
# User-embedding Reconstruction Mechanism!!!
    def recommend(self, batch, mode):
        ...
        movie: (batch_size)
        """
        context_entities, context_words, entities, user_id, movie = batch
    ...
    def converse(self, batch, mode):
        context_tokens, context_entities, context_words, user_id, response = batch
